...
class CalculatorsControllerTest < ActionController::TestCase
  ...
  test "should create calculator" do
    assert_difference('Calculator.count') do
      post :create, calculator: { current_rent: @calculator.current_rent, email: @calculator.email, initial_cost: @calculator.initial_cost, post_code: @calculator.post_code, telephone: @calculator.telephone }
    end
  ...
  test "should update calculator" do
    patch :update, id: @calculator, calculator: { current_rent: @calculator.current_rent, email: @calculator.email, initial_cost: @calculator.initial_cost, post_code: @calculator.post_code, telephone: @calculator.telephone }
    assert_redirected_to calculator_path(assigns(:calculator))
  end
